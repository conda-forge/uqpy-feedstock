About uqpy-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/uqpy-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/uqpy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/uqpy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `uqpy` available on your platform:
...
```
mamba search uqpy --channel conda-forge
```
...
```
pixi search uqpy --channel conda-forge
```
...
mamba repoquery search uqpy --channel conda-forge

# List packages depending on `uqpy`:
mamba repoquery whoneeds uqpy --channel conda-forge

# List dependencies of `uqpy`:
mamba repoquery depends uqpy --channel conda-forge
```
...
* [@dgiovanis](https://github.com/dgiovanis/)
* [@dimtsap](https://github.com/dimtsap/)
* [@mds2120](https://github.com/mds2120/)
